...
// src/react/index.tsx
function LogLib({ config }) {
  (0, import_react.useEffect)(() => {
    record(config);
  }, []);
  return null;
}
function TrackView({ name, payload, children }) {
  ...
  const Element = import_react.default.cloneElement(children, {
    ref
  });
  return Element;
}
function TrackClick({ name, payload, children }) {
  const Element = import_react.default.cloneElement(children, {
    onClick: () => {
      loglib.track(name, payload);
    }
